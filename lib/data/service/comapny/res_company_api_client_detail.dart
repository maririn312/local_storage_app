...
class ResCompanyApiClient {
  Future<ResCompanyResponseDto> getResCompanyList(
    ...
    String url = 'http://${userDetailEntity.ip}/api/res.company';
    print(' url :  $url ');
    try {
    ...
    if (response.statusCode == 200 || response.statusCode == 202) {
      return ResCompanyResponseDto.fromRawJson(response.body);
    } else if (response.statusCode == 401) {
      return getResCompanyList(ip);
    }
